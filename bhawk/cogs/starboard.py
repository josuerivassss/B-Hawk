...
class Starboard(commands.Cog):
    ...
    async def starboard(self, ctx: HawkContext):
    ...
    async def starboard_enable(self, ctx: HawkContext):
    ...
    async def starboard_disable(self, ctx: HawkContext):
    ...
    async def starboard_channel(self, ctx: HawkContext, channel: discord.TextChannel):
    ...
    async def starboard_emoji(self, ctx: HawkContext, emoji: str):
    ...
    async def starboard_threshold(self, ctx: HawkContext, amount: commands.Range[int, 2, 250]):
    ...
    async def starboard_selfstars(self, ctx: HawkContext, state: bool):
