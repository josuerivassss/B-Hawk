...
from bhawk.help import send_help_group
...
async def _image_bytes_from_message(ctx: HawkContext, message: discord.Message) -> Optional[bytes]:
...
async def _referenced_message(ctx: HawkContext) -> Optional[discord.Message]:
...
class Fun(commands.Cog):
    ...
    async def edit(self, ctx: HawkContext):
        """Image manipulation commands"""
    ...
    async def image_communism(self, ctx: HawkContext, user: Optional[discord.User]):
    ...
    async def image_simp(self, ctx: HawkContext, user: Optional[discord.User]):
    ...
    async def image_delete(self, ctx: HawkContext, user: Optional[discord.User]):
    ...
    async def image_rainbow(self, ctx: HawkContext, user: Optional[discord.User]):
    ...
    async def image_deepfry(self, ctx: HawkContext, user: Optional[discord.User]):
    ...
    async def image_gray(self, ctx: HawkContext, user: Optional[discord.User]):
    ...
    async def image_mirror(self, ctx: HawkContext, user: Optional[discord.User]):
        """Applies a gray-scale filter to the avatar of an user"""
        await ctx.think()
        image_bytes = await resolve_image_bytes(ctx, user)
        avatar = self.bot.toolkit.images.from_bytes(image_bytes).resize((512, 512))
    ...
    async def image_pixel(self, ctx: HawkContext, user: Optional[discord.User]):
    ...
    async def image_sonic(self, ctx: HawkContext, *, text: str):
    ...
    async def image_titan(self, ctx: HawkContext, text1: str, text2: str):
    ...
    async def image_twoways(self, ctx: HawkContext, text1: str, text2: str):
    ...
    async def image_ship(self, ctx: HawkContext, user1: discord.User, user2: Optional[discord.User] = None):
    ...
    @discord.app_commands.allowed_installs(guilds=True, users=True)
    @discord.app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
    async def caption(self, ctx: HawkContext, user: Optional[discord.User], *, text: str):
    ...
    @discord.app_commands.allowed_installs(guilds=True, users=True)
    @discord.app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
    async def to_gif(self, ctx: HawkContext):
