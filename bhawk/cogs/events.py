...
from bhawk.cogs.configuration import CommandDisabledError
from bhawk.blacklist import BlacklistedError
...
class Events(commands.Cog):
    ...
    @commands.Cog.listener()
    async def on_command_error(self, ctx: HawkContext, error: commands.CommandError):
