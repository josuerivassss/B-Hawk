...
class Greetings(commands.Cog):
    ...
    async def welcome(self, ctx: HawkContext):
    ...
    async def welcome_enable(self, ctx: HawkContext):
    ...
    async def welcome_disable(self, ctx: HawkContext):
    ...
    async def welcome_channel(self, ctx: HawkContext, channel: discord.TextChannel):
    ...
    async def welcome_message(self, ctx: HawkContext, *, message: str):
    ...
    async def welcome_preview(self, ctx: HawkContext):
    ...
    async def leave(self, ctx: HawkContext):
    ...
    async def leave_enable(self, ctx: HawkContext):
    ...
    async def leave_disable(self, ctx: HawkContext):
    ...
    async def leave_channel(self, ctx: HawkContext, channel: discord.TextChannel):
    ...
    async def leave_message(self, ctx: HawkContext, *, message: str):
    ...
    async def leave_preview(self, ctx: HawkContext):
    ...
    async def on_member_join(self, member: discord.Member):
        ...
        if not channel:
            return
        fake_ctx = HawkContext.create_for_event(self.bot, member, guild=member.guild) # Create a fake context for interpolation
