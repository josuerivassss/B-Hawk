...
class BaseView(discord.ui.View):
    ...
    def __init__(self, ctx: HawkContext, locale: Locale, timeout: float | None = 180.0) -> None:
    ...
    async def interaction_check(self, interaction: discord.Interaction) -> bool:
        ...
        if interaction.user.id != expected_user_id:
            message = f"{self.t.get('errors.viewNotForYou', user=interaction.user.mention)} {HawkEmojis.Angry}"
