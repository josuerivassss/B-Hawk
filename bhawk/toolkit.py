...
from bhawk import timeparse
from bhawk.interpolation.interpolator import InterpolationEngine
from bhawk.logging_setup import get_logger
from bhawk.managers.images import ImagesManager
from bhawk.managers.typeface import TypefaceManager
from bhawk.placeholders import PlaceholderManager
...
class ToolKit:
    ...
    def __init__(
        self, bot: HawkBot, images_path: str = "./assets/images", fonts_path: str = "./assets/fonts"
    ) -> None:
        self.bot = bot
